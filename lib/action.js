...
class Action {
  ...
  constructor(handler, dispatcher, standalone) {
    ...
    this.boundWrapper.subscribe = (listener) => this.dispatcher.subscribe(this, listener);
    this.boundWrapper.unsubscribe = (listener) => this.dispatcher.unsubscribe(this, listener);
